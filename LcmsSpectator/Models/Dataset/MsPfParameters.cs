...
namespace LcmsSpectator.Models.Dataset
{
    ...
    public class MsPfParameters
    {
        ...
        /// <summary>
        /// Gets or sets the FASTA database file.
        /// </summary>
        public string DatabaseFile { get; set; }

        /// <summary>
        /// Gets or sets the feature file.
        /// </summary>
        ...
        private static MsPfParameters ReadFromParameterFile(string filePath)
        {
            ...
            foreach (var line in file)
            {
                ...
                {
                    case "SpecFile":
                        param.PuSpecFile = parts[0];
                        break;
                    case "DatabaseFile":
                        param.DatabaseFile = parts[0];
                        break;
                    case "FeatureFile":
                        param.FeatureFile = parts[0];
                        break;
                    case "SearchMode":
        ...
        private static SearchModification ParseModification(string modificationStr)
        {
            ...
            Modification modification = Modification.Get(name) ??
                                        SingletonProjectManager.Instance.RegisterModification(name, composition);
