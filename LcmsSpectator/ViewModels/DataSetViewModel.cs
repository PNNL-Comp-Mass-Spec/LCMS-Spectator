...
namespace LcmsSpectator.ViewModels
{
    public class DataSetViewModel: ViewModelBase
    {
        ...
        public DataSetViewModel(IMainDialogService dialogService, ITaskService taskService)
        {
            ...
            XicViewModel = new XicViewModel(_dialogService, TaskServiceFactory.GetTaskServiceLike(_taskService), messenger);
            SpectrumViewModel = new SpectrumViewModel(_dialogService, TaskServiceFactory.GetTaskServiceLike(_taskService), messenger);
            ScanViewModel = new ScanViewModel(_dialogService, TaskServiceFactory.GetTaskServiceLike(_taskService), new List<PrSm>(), messenger);
            IonTypeSelectorViewModel = new IonTypeSelectorViewModel(_dialogService, messenger);
            IonListViewModel = new IonListViewModel(_dialogService, _taskService, messenger);
