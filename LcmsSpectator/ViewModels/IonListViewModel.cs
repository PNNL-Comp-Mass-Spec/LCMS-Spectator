    ...
    public class IonListViewModel : ReactiveObject
    {
        ...
        public IonListViewModel(ILcMsRun lcms)
        {
            ...
            precursorObservable.Where(x => x.Item2)
                .SelectMany(async x => PrecursorViewMode == PrecursorViewMode.Isotopes ? await this.GenerateIsotopeLabelsAsync(IcParameters.Instance.HeavyModifications)
            ...
            IcParameters.Instance.WhenAnyValue(x => x.PrecursorRelativeIntensityThreshold, x => x.HeavyModifications)
                        ...
                        .SelectMany(async x => PrecursorViewMode == PrecursorViewMode.Isotopes ? await this.GenerateIsotopeLabelsAsync(x.Item2)
