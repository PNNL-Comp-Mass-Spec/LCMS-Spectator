...
namespace LcmsSpectator.Views.Plots
{
    ...
    public partial class SpectrumView : UserControl
    {
        ...
        public SpectrumView()
        {
            ...
            Ms2Spectrum.DataContextChanged += (o, e) => Ms2Spectrum.ContextMenu.DataContext = Ms2Spectrum.DataContext;
            PreviousMs1.DataContextChanged += (o, e) => PreviousMs1.ContextMenu.DataContext = PreviousMs1.DataContext;
            NextMs1.DataContextChanged += (o, e) => NextMs1.ContextMenu.DataContext = NextMs1.DataContext;
